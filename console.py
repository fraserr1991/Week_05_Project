...
inventory_item_2 = Inventory("The Oracle", manufacturer_1, "Bean to cup coffee machine with automatic milk frother", 5, 1000, 1500, "https://johnlewis.scene7.com/is/image/JohnLewis/233712798?$rsp-pdp-port-640-82$")
...
inventory_item_5 = Inventory("One Touch CoffeeHouse", manufacturer_3, "One touch coffee drinks", 30, 90, 159, "https://media.currys.biz/i/currysprod/10226012?$l-large$&fmt=auto")
